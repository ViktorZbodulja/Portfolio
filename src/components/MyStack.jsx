    ...
    <div className="myStack" >
      ...
      <motion.div className="about_text" ref={element} variants={scrollReveal2} animate={controls} initial="hidden">
        ...
        <div className="description_container">
          ...
          <div className="short_description">Also I am actively working towards expanding my skills into the realm of <span>Backend</span> aiming for the utmost reliability and excellence in applications.</div>
        </div>
      </motion.div>
    </div>
  );
